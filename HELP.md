...
* [Spring Configuration Processor](https://docs.spring.io/spring-boot/3.4.4-SNAPSHOT/specification/configuration-metadata/annotation-processor.html)
* [Spring HATEOAS](https://docs.spring.io/spring-boot/3.4.4-SNAPSHOT/reference/web/spring-hateoas.html)
* [Spring Data JPA](https://docs.spring.io/spring-boot/3.4.4-SNAPSHOT/reference/data/sql.html#data.sql.jpa-and-spring-data)
* [Spring Boot Actuator](https://docs.spring.io/spring-boot/3.4.4-SNAPSHOT/reference/actuator/index.html)
